...
int main()
{
  ...
  double sigma_pos [3] = {0.4, 0.4, 0.01}; // GPS measurement uncertainty [x [m], y [m], theta [rad]]
  double sigma_landmark [2] = {0.05, 0.05}; // Landmark measurement uncertainty [x [m], y [m]]
